...
namespace {
    ...
    bool test_string_roundtrip(std::mt19937_64 &rng) {
        ...
        const auto limb_value = t81::io::from_string<t81::core::limb>("42", 10);
    ...
    bool test_gcd_cases() {
        ...
        const auto multiplier_a = t81::io::from_string<bigint>("12345678901234567890");
        const auto multiplier_b = t81::io::from_string<bigint>("12345678901234567891");
