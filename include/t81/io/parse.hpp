...
namespace t81::io {
    ...
    template <typename Int> inline Int from_string(std::string_view text, int base = 10) {
        static_assert(std::is_same_v<Int, t81::core::limb> ||
                          std::is_same_v<Int, t81::core::bigint>,
